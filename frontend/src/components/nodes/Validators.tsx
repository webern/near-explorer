            ...
            >
              <thead>
                <tr className="validators-header-row">
                  <th />
                  <th>#</th>
                  <th>{translate("component.nodes.Validators.location")}</th>
                  <th>{translate("component.nodes.Validators.validator")}</th>
                  <th>{translate("component.nodes.Validators.fee")}</th>
                  <th>{translate("component.nodes.Validators.delegators")}</th>
                  <th className="text-right">
                    {translate("component.nodes.Validators.stake")}
                  </th>
                  <th>
                    {translate("component.nodes.Validators.cumulative_stake")}
                  </th>
                </tr>
              </thead>
              <tbody>
